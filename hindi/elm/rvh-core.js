	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'subUnits',
				A2($elm$json$Json$Encode$array, $author$project$Akshar$encodeAkshar, fvl.O.z)),
				_Utils_Tuple2(
				'isComposite',
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A3($elm_community$array_extra$Array$Extra$map2, $author$project$RVHGhazal$combineAksharRK, m.O.z, m.as)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'subUnits',
				A2($elm$json$Json$Encode$array, $author$project$RVHVarnikLine$encodeMaapneeUnits, m.z))
			]));
};
...
var $author$project$RVHLine$PoemLine = F3(
	function (str, rhythmTotal, units) {
		return {aS: rhythmTotal, I: str, z: units};
	});
...
var $author$project$RVHFreeVerse$CompositeLine = F4(
	function (originalLineI, rhythm, remainder, multipleOfBase) {
		return {af: multipleOfBase, ap: originalLineI, ag: remainder, c: rhythm};
	});
...
var $author$project$RVHGhazal$setMisraaKaafiyaa = F4(
	function (misraa, radeefLen, kaafiyaa, kaafiyaaI) {
		...
		while (true) {
			...
			var ai = (($elm$core$Array$length(misraa.O.z) - radeefLen) - kaafiyaaI) - 1;
			var a = A2(
				$elm$core$Maybe$withDefault,
				$author$project$Akshar$emptyAkshar,
				A2($elm$core$Array$get, ai, misraa.O.z));
			if (_Utils_eq(
...
var $author$project$RVHGhazal$setMisraaRadeef = F3(
	function (misraa, radeef, radeefI) {
		...
		while (true) {
			...
			var ai = ($elm$core$Array$length(misraa.O.z) - radeefI) - 1;
			var a = A2(
				$elm$core$Maybe$withDefault,
				$author$project$Akshar$emptyAkshar,
				A2($elm$core$Array$get, ai, misraa.O.z));
...
var $author$project$RVHVarnikLine$Varna = F7(
	function (a, str, rhythm, gan, idx, patternValue, varnaType) {
		return {l: a, ad: gan, E: idx, B: patternValue, c: rhythm, I: str, ac: varnaType};
	});
...
var $author$project$RVHVarnikLine$setYati = function (varna) {
	return A7($author$project$RVHVarnikLine$Varna, varna.l, varna.I, varna.c, varna.ad, varna.E, '-1', varna.ac);
};
...
var $author$project$RVHVarnikLine$mProcess = function (bmaapnee) {
	var muWOZero = A2(
		...
		A3($author$project$RVHVarnikLine$mUtoUwIx, bmaapnee.z, 0, $elm$core$Array$empty));
