...
var $author$project$RVHVarnikLine$Varna = F7(
	function (a, str, rhythm, gan, idx, patternValue, varnaType) {
		return {a: a, gan: gan, idx: idx, patternValue: patternValue, rhythm: rhythm, str: str, varnaType: varnaType};
	});
...
var $author$project$RVHVarnikLine$arStr = function (a) {
	return $elm$core$String$fromInt(a.rhythm);
};
...
var $author$project$RVHVarnikLine$setYati = function (varna) {
	return A7($author$project$RVHVarnikLine$Varna, varna.a, varna.str, varna.rhythm, varna.gan, varna.idx, '-1', varna.varnaType);
};
		...
		while (true) {
			...
			if ((_Utils_cmp(
				...
				if (!vu.rhythm) {
					...
					if (_Utils_eq(mu.unitVal, vu.rhythm)) {
						var $temp$vUnits = vUnits,
							$temp$vi = vi + 1,
							$temp$mUnits = mUnits,
							$temp$mi = mi + 1;
