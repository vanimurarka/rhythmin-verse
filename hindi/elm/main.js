...
var $author$project$Main$padUIAwithZero = F2(
	function (uia, i) {
		padUIAwithZero:
		while (true) {
			var ui2 = A2(
				$elm$core$Maybe$withDefault,
				A3($author$project$Main$UI, '0', -1, ''),
			...
			if (_Utils_cmp(i, len) > -1) {
				...
				if (_Utils_eq(ui1.i, ui2.i)) {
					...
					var $temp$uia = A3(
						...
						i + 1,
						A3($author$project$Main$UI, '0', i + 1, ''),
						uia),
						$temp$i = i + 1;
					uia = $temp$uia;
					i = $temp$i;
...
var $author$project$Main$setGanameToGanset = F4(
	function (gs, gn, i, ns) {
		setGanameToGanset:
		while (true) {
			var ui = A2(
...
var $author$project$Main$ganSetWGaname = F2(
	function (gs, gn) {
		return A4($author$project$Main$setGanameToGanset, gs, gn, 0, $elm$core$Array$empty);
	});
...
var $author$project$Main$ganSigToGan = function (sig) {
	switch (sig) {
		case '122':
			return 'y';
		case '222':
...
var $author$project$Main$ganSetToGanName = function (ganset) {
	var sig = A3(
		...
		A2(
			...
			ganset));
	return $author$project$Main$ganSigToGan(sig);
};
...
var $author$project$Main$ganSets = F2(
	function (a, na) {
		ganSets:
		while (true) {
...
var $author$project$Main$p = $elm$core$Array$fromList(
	_List_fromArray(
		[1, 1, 1, 2, 0, 2, 1, 2, 0, 2]));
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$pRUI = function (el) {
	return el.u !== '0';
};
var $author$project$Main$pUI = F3(
	function (i, a, a1) {
		pUI:
		while (true) {
			var u = A2(
...
var $author$project$Main$prui = A2(
	$elm$core$Array$filter,
	$author$project$Main$pRUI,
	A3($author$project$Main$pUI, 0, $author$project$Main$p, $elm$core$Array$empty));
var $author$project$Main$gansets = A2($author$project$Main$ganSets, $author$project$Main$prui, $elm$core$Array$empty);
var $author$project$Main$gans = A2($elm$core$Array$map, $author$project$Main$ganSetToGanName, $author$project$Main$gansets);
...
var $author$project$Main$gansetsWgan = A3($elm_community$array_extra$Array$Extra$map2, $author$project$Main$ganSetWGaname, $author$project$Main$gansets, $author$project$Main$gans);
var $author$project$Main$uisWgan = A3($elm$core$Array$foldr, $elm$core$Array$append, $elm$core$Array$empty, $author$project$Main$gansetsWgan);
var $author$project$Main$uisWganWZ = A2($author$project$Main$padUIAwithZero, $author$project$Main$uisWgan, 0);
var $author$project$Main$main = $elm$html$Html$text(
	$elm$core$Debug$toString($author$project$Main$uisWganWZ));
