...
class cRhythmUnit {
    ...
    _replaceFirstChar(newMainChar, newMainCharCode) {
...
class cMaatraaUnit extends cRhythmUnit {
    ...
    calculateHalfLetterRhythmAmt(p, n) {
        // debugger;
...
class cGhazal extends cPoem {
    ...
    calculateRadeef() {
        ...
        for (i = 0; i < this.lines.length; i++) {
            ...
            // first 2 lines
            if (i <= 1)
                supposedlyRelevantLine = true;
            // intermediate line followed by blank line
            if ((i > 1) && (i < (this.lines.length - 1)) && (this.lines[i + 1].subUnits.length == 0))
                supposedlyRelevantLine = true;
            // last line
